...
We now present numerical evidence from three independent pipelines implemented in \texttt{code/gravitational\_baseline\_numerics.py}:
...
This is the exact dispersion of a massless spin-2 \emph{collective excitation} of the substrate.
...
The repository contains the full codebase in \texttt{/code} and all figures in \texttt{/figures}. Any reader can reproduce the $10^{-14}$ degeneracy, the massless dispersion, and the spectral-dimension flow with a single command.
